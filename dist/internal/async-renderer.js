...
var AsyncRenderer = exports["default"] = /*#__PURE__*/function () {
  ...
  return _createClass(AsyncRenderer, [{
    key: "_generateUUID",
    ...
    value: function _addRenderTask(task) {
      var uuid = this._generateUUID(_uuid["default"]);
      this.tasks.push({
        uuid: uuid,
        task: task
      });
    ...
    key: "doRender",
    value: function () {
      var _doRender = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(callbackCheckFiltered) {
        var _this = this;
