...
var MathRenderer = exports["default"] = /*#__PURE__*/function (_AsyncRenderer) {
  function MathRenderer(cache, callbackAddReplace) {
    ...
    return _callSuper(this, MathRenderer, [null, callbackAddReplace]);
  }
  ...
  return _createClass(MathRenderer, [{
    ...
    key: "doRender",
    value: function () {
      var _doRender = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(callbackCheckFiltered) {
        var mathjax, _iterator, _step, task, result, errorMessage;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              mathjax = getMathjax();
              _iterator = _createForOfIteratorHelper(this.tasks);
              _context.prev = 2;
              _iterator.s();
            case 4:
            ...
            case 8:
              ...
              try {
                ...
                errorMessage = "Failed to render ".concat(task.task.displayMode ? 'display' : 'inline', " math: ") + _util["default"].inspect(task.task.texCode) + '\n' + e.toString();
                result = formatErrorMessage(errorMessage);
              }
              if (task.task.displayMode) result = "<p><span style=\"margin-left: 50%; transform: translateX(-50%); display: inline-block; \">".concat(result, "</span></p>");
