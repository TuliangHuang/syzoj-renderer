...
var _node = _interopRequireDefault(require("@syntect/node"));
...
function _highlight() {
  _highlight = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(code, language, cache) {
    var _language;
    var options,
      defaultOptions,
      cacheKey,
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          language = (_language = language) === null || _language === void 0 ? void 0 : _language.toLowerCase();
          ...
          options = (0, _objectAssignDeep["default"])({}, defaultOptions, options);
          if (!cache) {
            _context2.next = 12;
            break;
          }
        ...
        case 16:
          ...
          break;
        case 19:
          result = _node["default"].highlight(code, language, 'hl-').html;
        case 20:
          _context2.next = 25;
          break;
        case 22:
          ...
          console.error("Highlighting error for language \"".concat(language, "\":"), _context2.t0);
        case 25:
          if (typeof result !== 'string' || result.length === 0) {
            result = (0, _escapeHtml["default"])(code);
          }
          _ref = Array.isArray(options.wrapper) ? options.wrapper : ['', ''], _ref2 = _slicedToArray(_ref, 2), startWrapper = _ref2[0], endWrapper = _ref2[1];
          result = "".concat(startWrapper).concat(result).concat(endWrapper);
...
var HighlightRenderer = exports["default"] = /*#__PURE__*/function (_AsyncRenderer) {
  function HighlightRenderer(cache, callbackAddReplace) {
    var _this;
    var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    _classCallCheck(this, HighlightRenderer);
    _this = _callSuper(this, HighlightRenderer, [cache, callbackAddReplace]);
  ...
  return _createClass(HighlightRenderer, [{
    ...
    value: function _generateUUID(uuidGenerator) {
      return "<pre>".concat(uuidGenerator(), "</pre>");
    }
  }, {
    key: "_shouldCache",
    ...
    key: "_doRender",
    value: function () {
      var _doRender2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(task) {
