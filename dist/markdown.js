...
function _render() {
  _render = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(input, cache, callbackFilter) {
    var options,
      cacheKey,
      cached,
      uuidReplaces,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          cacheKey = cache && (0, _objectHash["default"])({
            type: 'Markdown',
            task: input,
            options: options
          });
        ...
        case 8:
          ...
          mdOptions = (0, _objectAssignDeep["default"])({
            html: true,
            breaks: false,
            linkify: true,
            typographer: false,
            highlight: function highlight(code, lang) {
              return highlightRenderer.addRenderTask(code, lang);
            }
          }, options.markdownIt || {});
          mathOptions = (0, _objectAssignDeep["default"])({
            inlineOpen: '$',
            inlineClose: '$',
            blockOpen: '$$',
            blockClose: '$$',
          ...
          renderer = new _markdownIt["default"](mdOptions).use(_markdownItMathLoose["default"], mathOptions);
          ...
          _context.next = 19;
          return Promise.all([mathRenderer.doRender(function (uuid) {
            return !html.includes(uuid);
          }), highlightRenderer.doRender(function (uuid) {
            return !html.includes(uuid);
          })]);
        case 19:
          for (_i = 0, _Object$entries = Object.entries(uuidReplaces); _i < _Object$entries.length; _i++) {
            _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2), uuid = _Object$entries$_i[0], content = _Object$entries$_i[1];
